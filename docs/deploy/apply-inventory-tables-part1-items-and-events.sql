-- Part 1/3 — inventory_items + inventory_events
-- 若整段脚本报错「cannot insert multiple commands into a prepared statement」，请按 part1 → part2 → part3 依次执行。
-- 前置：stores、customers、repair_orders、current_store_id() 已存在。
