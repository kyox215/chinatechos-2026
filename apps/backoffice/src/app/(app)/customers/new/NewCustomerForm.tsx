  ...
  return (
    <div className="mx-auto max-w-xl space-y-4">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display text-lg font-semibold tracking-tight">新建客户</h1>
      </div>

      <div className="glass-card rounded-2xl border border-border bg-surface p-4 space-y-3">
        <div>
          <label className="mb-1 block text-sm text-muted-foreground">电话 (必填)</label>
          <input
        ...
        <div>
          <label className="mb-1 block text-sm text-muted-foreground">备注</label>
          <textarea
        ...
        {error && (
          <div className="rounded-xl border border-border bg-status-danger/10 px-3 py-2 text-xs text-status-danger-foreground">
            {error}
          </div>
        )}
